...
import sp.de.blinkt.openvpn.core.IServiceStatus;
import sp.de.blinkt.openvpn.core.OpenVPNStatusService;
import sp.de.blinkt.openvpn.core.PasswordCache;
import sp.de.blinkt.openvpn.core.Preferences;
...
public class LaunchVPN extends Activity {
    ...
    public static final String EXTRA_KEY = "sp.de.blinkt.openvpn.shortcutProfileUUID";
    public static final String EXTRA_NAME = "sp.de.blinkt.openvpn.shortcutProfileName";
    public static final String EXTRA_HIDELOG = "sp.de.blinkt.openvpn.showNoLogWindow";
