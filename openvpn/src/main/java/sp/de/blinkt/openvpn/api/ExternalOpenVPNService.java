...
import sp.de.blinkt.openvpn.core.ConfigParser;
import sp.de.blinkt.openvpn.core.ConfigParser.ConfigParseError;
import sp.de.blinkt.openvpn.core.ConnectionStatus;
import sp.de.blinkt.openvpn.core.IOpenVPNServiceInternal;
import sp.de.blinkt.openvpn.core.OpenVPNService;
import sp.de.blinkt.openvpn.core.ProfileManager;
import sp.de.blinkt.openvpn.core.VPNLaunchHelper;
    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        private void startProfile(VpnProfile vp)
        {
            ...
            if(vpnPermissionIntent != null || neddPassword != 0){
                ...
                shortVPNIntent.setClass(getBaseContext(), sp.de.blinkt.openvpn.LaunchVPN.class);
                shortVPNIntent.putExtra(sp.de.blinkt.openvpn.LaunchVPN.EXTRA_KEY, vp.getUUIDString());
                shortVPNIntent.putExtra(sp.de.blinkt.openvpn.LaunchVPN.EXTRA_HIDELOG, true);
