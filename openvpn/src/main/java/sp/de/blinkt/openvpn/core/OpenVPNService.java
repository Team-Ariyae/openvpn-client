...
import sp.de.blinkt.openvpn.DisconnectVPNActivity;
import sp.de.blinkt.openvpn.LaunchVPN;
import sp.de.blinkt.openvpn.R;
import sp.de.blinkt.openvpn.VpnProfile;
import sp.de.blinkt.openvpn.api.ExternalAppDatabase;
import sp.de.blinkt.openvpn.core.VpnStatus.ByteCountListener;
import sp.de.blinkt.openvpn.core.VpnStatus.StateListener;
import sp.de.blinkt.openvpn.utils.TotalTraffic;

import static sp.de.blinkt.openvpn.core.App.appsList;
import static sp.de.blinkt.openvpn.core.ConnectionStatus.LEVEL_CONNECTED;
import static sp.de.blinkt.openvpn.core.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;
import static sp.de.blinkt.openvpn.core.NetworkSpace.IpAddress;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    public static final String START_SERVICE = "sp.de.blinkt.openvpn.START_SERVICE";
    public static final String START_SERVICE_STICKY = "sp.de.blinkt.openvpn.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "sp.de.blinkt.openvpn.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "sp.de.blinkt.openvpn.DISCONNECT_VPN";
    ...
    private static final String PAUSE_VPN = "sp.de.blinkt.openvpn.PAUSE_VPN";
    private static final String RESUME_VPN = "sp.de.blinkt.openvpn.RESUME_VPN";

    public static final String EXTRA_CHALLENGE_TXT = "sp.de.blinkt.openvpn.core.CR_TEXT_CHALLENGE";
    public static final String EXTRA_CHALLENGE_OPENURL = "sp.de.blinkt.openvpn.core.OPENURL_CHALLENGE";
...
//        }
    ...
    synchronized void unregisterDeviceStateReceiver() {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: sp.de.blinkt.openvpn.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                iae.printStackTrace();
            }
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class cl = Class.forName("sp.de.blinkt.openvpn.core.OpenVPNThreadv3");
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("sp.de.blinkt.openvpn.VPN_STATUS");
